...
type Bet struct {
	...
	OddsType OddsType `protobuf:"varint,4,opt,name=odds_type,json=oddsType,proto3,enum=furysports.fury.bet.OddsType" json:"odds_type,omitempty"`
	...
	Status Bet_Status `protobuf:"varint,8,opt,name=status,proto3,enum=furysports.fury.bet.Bet_Status" json:"status,omitempty"`
	// result is the result of the bet, such as `won` or `lost`.
	Result Bet_Result `protobuf:"varint,9,opt,name=result,proto3,enum=furysports.fury.bet.Bet_Result" json:"result,omitempty"`
...
func init() {
	proto.RegisterEnum("furysports.fury.bet.Bet_Status", Bet_Status_name, Bet_Status_value)
	proto.RegisterEnum("furysports.fury.bet.Bet_Result", Bet_Result_name, Bet_Result_value)
	proto.RegisterType((*Bet)(nil), "furysports.fury.bet.Bet")
	proto.RegisterType((*UID2ID)(nil), "furysports.fury.bet.UID2ID")
	proto.RegisterType((*ActiveBet)(nil), "furysports.fury.bet.ActiveBet")
	proto.RegisterType((*SettledBet)(nil), "furysports.fury.bet.SettledBet")
	proto.RegisterType((*BetFulfillment)(nil), "furysports.fury.bet.BetFulfillment")
}
...
var fileDescriptor_5babc7dd42d65118 = []byte{
	...
	,
}
