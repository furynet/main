...
// source: fury/orderbook/stats.proto
...
func init() {
	proto.RegisterType((*OrderBookStats)(nil), "furysports.fury.orderbook.OrderBookStats")
}

func init() { proto.RegisterFile("fury/orderbook/stats.proto", fileDescriptor_ce6c435cd3c97d3f) }
