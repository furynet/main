...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furysports.fury.orderbook.GenesisState")
}

func init() { proto.RegisterFile("fury/orderbook/genesis.proto", fileDescriptor_910812d215ece8f7) }
